      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="http://socialdrinkers.web.engr.illinois.edu/p/Project/mixesPage/mixesPage.php">Mixes</a></li>
			<li class="active"><a href="http://socialdrinkers.web.engr.illinois.edu/p/Project/aboutPage/aboutPage.php">About</a></li>
